...
if ($obj1 == $obj2) {
    echo "Igualdad no estricta<b/><br>";
} else {
    echo "los objetos no son iguales en valores<b/><br>";
}

if ($obj1 === $obj2) {
    echo "Igualdad estricta<b/><br>";
} else {
    echo "No son estrictamente iguales<b/><br>";
}
...
if ($obj1 === $obj2) {
    echo "Ahora son Igualdad estricta<b/><br>";
} else {
    echo "No son estrictamente iguales<b/><br>";
}
